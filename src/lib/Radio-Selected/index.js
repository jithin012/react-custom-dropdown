...
export default function RadioSelected(props) {
    return (
        <div
            ...
            onClick={() => { props.onClick && props.onClick() }} style={{cursor:'pointer'}}
        >
            <svg height={props.height} viewBox="0 0 13 13" width={props.width} xmlns="http://www.w3.org/2000/svg">
                <g fill={props.fill} fillRule="evenodd">
                    <path d="m-158-350h1280v1828h-1280z" fill="#fff" />
                    <g stroke="#50b7e8" strokeWidth=".5">
                        <circle cx="6.5" cy="6.5" r="6.25" />
                        <circle cx="6.5" cy="6.5" fill="#50b7e8" r="3.25" />
                    </g>
                </g>
            </svg>
        </div>
